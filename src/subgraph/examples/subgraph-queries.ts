...
import { Market_OrderBy, OrderDirection } from '../generated/perp-optimism-subgraph-types'
...
async function main() {
  ...
  const client = createSubgraphClient(process.env.PERP_V2_OPTIMISM_SUBGRAPH_URL || endpoint)
